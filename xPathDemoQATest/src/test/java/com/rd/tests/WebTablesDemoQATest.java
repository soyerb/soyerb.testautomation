...
//    }
    ...
    public void fillFormOnDemoQA(){
        ...
        WebElement btn2Clk = driver.findElement(new By.ByXPath("//*[@id=\"addNewRecordButton\"]"));
        btn2Clk.click();
        WebElement firstName = driver.findElement(new By.ByXPath("//*[@id=\"firstName\"]"));
        firstName.sendKeys("John");
        WebElement lastName = driver.findElement(new By.ByXPath("//*[@id=\"lastName\"]"));
        lastName.sendKeys("Doe");
        WebElement userEmail = driver.findElement(new By.ByXPath("//*[@id=\"userEmail\"]"));
        userEmail.sendKeys("doejohn@gmail.com");
        WebElement userAge = driver.findElement(new By.ByXPath("//*[@id=\"age\"]"));
        userAge.sendKeys("50");
        WebElement userSalary = driver.findElement(new By.ByXPath("//*[@id=\"salary\"]"));
        userSalary.sendKeys("10000");
        WebElement userDept = driver.findElement(new By.ByXPath("//*[@id=\"department\"]"));
        userDept.sendKeys("Finance");
        WebElement submitClick = driver.findElement(new By.ByXPath("//*[@id=\"submit\"]"));
        submitClick.click();
...
//        WebElement headerTitle = driver.findElement(new By.ByXPath(""));
//        Assert.assertTrue(headerTitle.isDisplayed());
    }
